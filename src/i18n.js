...
const resources = {
  ...
  es: {
    translation: {
      ...
      home: { title: '¿Qué quieres analizar?', scan: 'Escanear', scanSub: 'Usa la cámara', screenshot: 'Captura', screenshotSub: 'Sube una imagen', link: 'Enlace', linkSub: 'Pega una URL', search: 'Buscar', searchSub: 'Escribe el nombre', searchPlaceholder: 'Ej. Sony WH-1000XM6, o pega un enlace…', footerNote: 'El análisis usa búsqueda web real: puede tardar unos segundos.', emptyTitle: '¿Qué quieres verificar?', emptyMessage: 'Escribe el nombre de un producto o pega un enlace abajo, luego pulsa buscar.', linkPromptTitle: 'Introduce el enlace', linkPromptMessage: 'Pega aquí el enlace del producto que quieres verificar.', linkAnalyze: 'Analizar', photoPermissionTitle: 'Permiso necesario', photoPermissionMessage: 'Para subir una captura debes permitir que TRUTH acceda a tus fotos.', screenshotSelectedTitle: 'Captura seleccionada', screenshotSelectedMessage: 'La captura se ha subido. El análisis de imágenes se conectará al motor TRUTH.', cameraPermissionTitle: 'Cámara necesaria', cameraPermissionMessage: 'Para usar Escanear debes permitir que TRUTH use la cámara.', cameraTitle: 'Encuadra el código QR del producto' },
      analyzing: { message1: 'Analizando el producto...', message2: 'Comprobando el precio actual...', message3: 'Comparando con precios anteriores...', message4: 'Evaluando el precio real...', message5: 'Preparando el resultado...' },
      result: { truthScore: 'Truth Score', currentPrice: 'Precio actual', fairPrice: 'Precio justo', potentialSaving: 'Ahorro potencial', savings: 'Ahorro', upTo: 'Hasta', explanation: 'Explicación', why: 'Por qué', priceTrend: 'Tendencia de precio', noPriceHistory: 'No hay historial de precio disponible.', alternatives: 'Alternativas', userReviews: 'Reseñas de usuarios', truthCheck: 'Truth Check', bestOffers: 'Mejores ofertas', shipping: 'Envío', go: 'Ir', priceAlert: 'Alerta de precio', alertMeAt: 'Avísame a €{{price}}', alertDescription: 'TRUTH te avisará cuando el precio alcance este nivel.', activate: 'Activar', askTruth: 'Pregunta a TRUTH' },
      ...
      common: { cancel: 'Cancelar', confirm: 'Confirmar', save: 'Guardar', delete: 'Eliminar', loading: 'Cargando…', error: 'Ha ocurrido un error', tryAgain: 'Reintentar', close: 'Cerrar' },
    },
  },
  ...
  fr: {
    translation: {
      ...
      home: { title: 'Que voulez-vous analyser ?', scan: 'Scanner', scanSub: 'Utiliser la caméra', screenshot: 'Capture d\'écran', screenshotSub: 'Importer une image', link: 'Lien', linkSub: 'Coller une URL', search: 'Rechercher', searchSub: 'Écrivez le nom', searchPlaceholder: 'Ex. Sony WH-1000XM6, ou collez un lien…', footerNote: "L'analyse utilise une recherche web réelle : cela peut prendre quelques secondes.", emptyTitle: 'Que voulez-vous vérifier ?', emptyMessage: "Écrivez le nom d'un produit ou collez un lien ci-dessous, puis appuyez sur rechercher.", linkPromptTitle: 'Entrez le lien', linkPromptMessage: 'Collez ici le lien du produit que vous voulez vérifier.', linkAnalyze: 'Analyser', photoPermissionTitle: 'Autorisation requise', photoPermissionMessage: "Pour importer une capture d'écran, autorisez TRUTH à accéder à vos photos.", screenshotSelectedTitle: "Capture d'écran sélectionnée", screenshotSelectedMessage: "La capture d'écran a été importée. L'analyse d'image sera connectée au moteur TRUTH.", cameraPermissionTitle: 'Caméra requise', cameraPermissionMessage: 'Pour utiliser Scanner, autorisez TRUTH à utiliser la caméra.', cameraTitle: 'Cadrez le QR code du produit' },
      analyzing: { message1: 'Analyse du produit en cours...', message2: 'Vérification du prix actuel...', message3: 'Comparaison avec les prix précédents...', message4: 'Évaluation du prix réel...', message5: 'Préparation du résultat...' },
      result: { truthScore: 'Truth Score', currentPrice: 'Prix actuel', fairPrice: 'Prix juste', potentialSaving: 'Économie potentielle', savings: 'Économie', upTo: "Jusqu'à", explanation: 'Explication', why: 'Pourquoi', priceTrend: 'Tendance des prix', noPriceHistory: 'Aucun historique de prix disponible.', alternatives: 'Alternatives', userReviews: 'Avis des utilisateurs', truthCheck: 'Truth Check', bestOffers: 'Meilleures offres', shipping: 'Livraison', go: 'Aller', priceAlert: 'Alerte de prix', alertMeAt: 'Alertez-moi à €{{price}}', alertDescription: 'TRUTH vous préviendra lorsque le prix atteindra ce niveau.', activate: 'Activer', askTruth: 'Demander à TRUTH' },
      ...
      common: { cancel: 'Annuler', confirm: 'Confirmer', save: 'Enregistrer', delete: 'Supprimer', loading: 'Chargement…', error: "Une erreur s'est produite", tryAgain: 'Réessayer', close: 'Fermer' },
    },
  },
  ...
  de: {
    translation: {
      ...
      home: { title: 'Was möchtest du analysieren?', scan: 'Scannen', scanSub: 'Kamera verwenden', screenshot: 'Screenshot', screenshotSub: 'Bild hochladen', link: 'Link', linkSub: 'URL einfügen', search: 'Suchen', searchSub: 'Namen eingeben', searchPlaceholder: 'Z.B. Sony WH-1000XM6, oder Link einfügen…', footerNote: 'Die Analyse nutzt echte Websuche: kann einige Sekunden dauern.', emptyTitle: 'Was möchtest du überprüfen?', emptyMessage: 'Gib den Namen eines Produkts ein oder füge unten einen Link ein, dann drücke Suchen.', linkPromptTitle: 'Link eingeben', linkPromptMessage: 'Füge hier den Link des Produkts ein, das du überprüfen möchtest.', linkAnalyze: 'Analysieren', photoPermissionTitle: 'Berechtigung erforderlich', photoPermissionMessage: 'Um einen Screenshot hochzuladen, erlaube TRUTH den Zugriff auf deine Fotos.', screenshotSelectedTitle: 'Screenshot ausgewählt', screenshotSelectedMessage: 'Der Screenshot wurde hochgeladen. Die Bildanalyse wird mit der TRUTH-Engine verbunden.', cameraPermissionTitle: 'Kamera erforderlich', cameraPermissionMessage: 'Um Scannen zu nutzen, erlaube TRUTH die Nutzung der Kamera.', cameraTitle: 'QR-Code des Produkts einrahmen' },
      analyzing: { message1: 'Produkt wird analysiert...', message2: 'Aktueller Preis wird geprüft...', message3: 'Vergleich mit früheren Preisen...', message4: 'Bewertung des realen Preises...', message5: 'Ergebnis wird vorbereitet...' },
      result: { truthScore: 'Truth Score', currentPrice: 'Aktueller Preis', fairPrice: 'Fairer Preis', potentialSaving: 'Mögliche Ersparnis', savings: 'Ersparnis', upTo: 'Bis zu', explanation: 'Erklärung', why: 'Warum', priceTrend: 'Preisverlauf', noPriceHistory: 'Kein Preisverlauf verfügbar.', alternatives: 'Alternativen', userReviews: 'Nutzerbewertungen', truthCheck: 'Truth Check', bestOffers: 'Beste Angebote', shipping: 'Versand', go: 'Los', priceAlert: 'Preisalarm', alertMeAt: 'Benachrichtige mich bei €{{price}}', alertDescription: 'TRUTH benachrichtigt dich, wenn der Preis dieses Niveau erreicht.', activate: 'Aktivieren', askTruth: 'TRUTH fragen' },
      ...
      common: { cancel: 'Abbrechen', confirm: 'Bestätigen', save: 'Speichern', delete: 'Löschen', loading: 'Wird geladen…', error: 'Ein Fehler ist aufgetreten', tryAgain: 'Erneut versuchen', close: 'Schließen' },
    },
  },
  ...
  pt: {
    translation: {
      ...
      home: { title: 'O que você quer analisar?', scan: 'Escanear', scanSub: 'Usar a câmera', screenshot: 'Captura de tela', screenshotSub: 'Enviar uma imagem', link: 'Link', linkSub: 'Colar uma URL', search: 'Pesquisar', searchSub: 'Digite o nome', searchPlaceholder: 'Ex. Sony WH-1000XM6, ou cole um link…', footerNote: 'A análise usa pesquisa web real: pode levar alguns segundos.', emptyTitle: 'O que você quer verificar?', emptyMessage: 'Digite o nome de um produto ou cole um link abaixo, depois pressione pesquisar.', linkPromptTitle: 'Insira o link', linkPromptMessage: 'Cole aqui o link do produto que deseja verificar.', linkAnalyze: 'Analisar', photoPermissionTitle: 'Permissão necessária', photoPermissionMessage: 'Para enviar uma captura de tela, permita que o TRUTH acesse suas fotos.', screenshotSelectedTitle: 'Captura de tela selecionada', screenshotSelectedMessage: 'A captura de tela foi enviada. A análise de imagem será conectada ao motor TRUTH.', cameraPermissionTitle: 'Câmera necessária', cameraPermissionMessage: 'Para usar Escanear, permita que o TRUTH use a câmera.', cameraTitle: 'Enquadre o código QR do produto' },
      analyzing: { message1: 'Analisando o produto...', message2: 'Verificando o preço atual...', message3: 'Comparando com preços anteriores...', message4: 'Avaliando o preço real...', message5: 'Preparando o resultado...' },
      result: { truthScore: 'Truth Score', currentPrice: 'Preço atual', fairPrice: 'Preço justo', potentialSaving: 'Economia potencial', savings: 'Economia', upTo: 'Até', explanation: 'Explicação', why: 'Por quê', priceTrend: 'Tendência de preço', noPriceHistory: 'Nenhum histórico de preço disponível.', alternatives: 'Alternativas', userReviews: 'Avaliações de usuários', truthCheck: 'Truth Check', bestOffers: 'Melhores ofertas', shipping: 'Envio', go: 'Ir', priceAlert: 'Alerta de preço', alertMeAt: 'Avise-me em €{{price}}', alertDescription: 'O TRUTH vai avisar quando o preço atingir esse nível.', activate: 'Ativar', askTruth: 'Perguntar ao TRUTH' },
      ...
      common: { cancel: 'Cancelar', confirm: 'Confirmar', save: 'Salvar', delete: 'Excluir', loading: 'Carregando…', error: 'Ocorreu um erro', tryAgain: 'Tentar novamente', close: 'Fechar' },
    },
  },
};
