  ...
  it: {
    translation: {
      ...
      account: {
        ...
        plusPrice: '$9.99 / mese',
        description: 'Ottieni più analisi e funzioni esclusive con TRUTH Plus.',
  ...
  en: {
    translation: {
      ...
      account: {
        ...
        description: 'Get more analyses and exclusive features with TRUTH Plus.',
  ...
  sc: {
    translation: {
      ...
      account: {
        ...
        plusTitle: 'TRUTH Plus',
        plusPrice: '$9.99 / mese',
        description: 'Otene prus analisis e funtziones esclusivas cun TRUTH Plus.',
  ...
  es: {
    translation: {
      ...
      account: {
        ...
        plusTitle: 'TRUTH Plus',
        plusPrice: '$9.99 / mes',
        description: 'Obtén más análisis y funciones exclusivas con TRUTH Plus.',
  ...
  fr: {
    translation: {
      ...
      account: {
        ...
        plusTitle: 'TRUTH Plus',
        plusPrice: '$9.99 / mois',
        description: 'Obtenez plus d’analyses et de fonctionnalités exclusives avec TRUTH Plus.',
  ...
  de: {
    translation: {
      ...
      account: {
        ...
        description: 'Erhalte mehr Analysen und exklusive Funktionen mit TRUTH Plus.',
  ...
  pt: {
    translation: {
      ...
      account: {
        ...
        plusTitle: 'TRUTH Plus',
        plusPrice: '$9.99 / mês',
        description: 'Tenha mais análises e recursos exclusivos com o TRUTH Plus.',
